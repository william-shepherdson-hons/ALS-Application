use crate::{auth::startup::fetch_jwt_token, services::{progress::update_progression, questions::generate_question}, settings::question_type::read_question_type, structs::{question_pair::QuestionPair, results::AssesmentResult}};
...
pub async fn generate_assessment(app_data_dir: String, topic: String, amount: i32) -> Result<Vec<QuestionPair>,String> {
    ...
    for _ in 0..amount {
        question_pairs.push(
            generate_question(&jwt, &topic, word).await
